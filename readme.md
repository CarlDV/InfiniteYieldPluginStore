...
- **Plugin Maker:** A visual IDE built with Monaco Editor for generating and compiling custom plugins.
- **Developer API:** Lightweight JSON endpoints for fetching catalog data in Luau.

## Adding Plugins
Upload your plugin file to the appropriate channel in the Infinite Yield Discord server. The site is synchronized periodically. Mention [@ymaw.1 (syh)](https://discord.com/users/857699215278866492) on Discord to request a manual sync.
